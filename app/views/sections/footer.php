        ...
        <div class="column dt-sc-one-fourth">
            <aside class="widget widget_links">
                ...
                <ul>
                    ...
                    <li><a href="http://www.phpindonesia.or.id/pages/program-kerja">Program Kerja</a></li>
...
<div class="copyright type2">
    <div class="container">
        <p>PHP Indonesia Community &copy; 2016. <a href="http://www.phpindonesia.or.id/pages/developer">Design By PHP Indonesia Web Team</a></p>
        <ul class="footer-links">
            <li>Web Hosted By <a href="http://www.phpindonesia.or.id/pages/hosted">Muhammad Saleh Hafizh Fajri</a></li>
        </ul>
    </div>
</div>
