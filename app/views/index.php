...
<section id="primary" class="content-full-width">
    ...
    <div class="full-width-section">
        ...
        <div class="container bootstrap" style="margin-top: -70px;">
            <div class="row">
                <div class="col-md-3">
                    <form class="aside-search" action="<?php echo $this->pathFor('membership-index'); ?>" method="get">
                        ...
                        <input type="text" id="area" class="aside-input" name="area" value="<?php echo $this->requestParam('area', null, true); ?>"/>
                            ...
                            <div class="col-md-4 col-xs-12 col-sm-6">
                                <div class="card-profile">
                                    ...
                                    <div class="card-profile-footer">
                                        ...
                                        <a href="<?php echo $this->pathFor('membership-profile', array('name' => $member['username'])); ?>"
