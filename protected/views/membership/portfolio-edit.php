			...
			<div class="woocommerce" style="padding:0px 30px;">
				...
				<form action="<?php echo $this->uri_path_for('membership-portfolio-edit', array('id' => $portfolio['member_portfolio_id'])); ?>" method="post" class="checkout" novalidate>
					...
					<div class="form-row form-row-wide">
						...
						<input type="text" id="company-name" name="company_name" value="<?php echo $this->fh_default_val('company_name', $portfolio['company_name']); ?>" />
                    ...
                    <?php
                    $display_end_work = 'style="display: block;"';
                    if ($portfolio['work_status'] == 'A') {
                        $display_end_work = 'style="display: none;"';
                    }
                    ?>

                    <div id="akhir-bekerja-block" <?php echo $display_end_work; ?> class="form-row form-row-wide">
                    ...
                    <div class="form-row form-row-wide" style="margin-top:10px;">
                        ...
                        <input type="text" id="job-title" name="job_title" value="<?php echo $this->fh_default_val('job_title', $portfolio['job_title']); ?>" />
                    ...
                    <div class="form-row form-row-wide">
                        ...
                        <input type="text" id="job-desc" name="job_desc" value="<?php echo $this->fh_default_val('job_desc', $portfolio['job_desc']); ?>" />
