<div class="portfolio-add-section" style="padding: 15px; height: 600px; overflow: auto;">
    ...
    <form action="<?php echo $this->uri_path_for('membership-skill-add'); ?>" method="post" class="checkout" novalidate>
        ...
        <table class="form-oprek">
            <tbody>
                <tr>
                    ...
                    <td>
                        <?php
                        echo $this->fh_input_select('skill_parent_id', $skills_main, array(
                            'id' => 'skill-parent-id',
                            'class' => 'input_full'
                        ));

                        echo $this->fh_show_errors('skill_parent_id', $_view_validation_errors_);
                        ?>
                    </td>
                </tr>
                ...
                <tr id="skill-id-row"<?php echo $style_skill_row; ?>>
                    ...
                    <td>
                    <?php
                    echo $this->fh_input_select('skill_id', $skills, array(
                        'id' => 'skill-id-dd',
                        'class' => 'input_full'
                    ));

                    echo $this->fh_show_errors('skill_id', $_view_validation_errors_);
                    ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        echo $this->fh_show_errors('skill_self_assesment', $_view_validation_errors_);
                        ?>
                        </div>
